...
class SolverBaseline(Solver):
    ...
    # Modify the incur_loss function in solver_freq_chop_baseline.py
    ...
    def incur_loss(self, carrier, carrier_reconst, msg, msg_reconst):
        ...
        # Calculate message loss and accuracy
        for i in range(len(msg)):
            ...
            msg_accuracy = calculate_accuracy(msg_reconst[i], msg[i])
            losses_log['msg_accuracy'] = msg_accuracy

        # Calculate carrier accuracy
        carrier_accuracy = calculate_accuracy(carrier_reconst, carrier)
        losses_log['carrier_accuracy'] = carrier_accuracy
